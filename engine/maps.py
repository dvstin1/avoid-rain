...
def create_world(name: str, saved_enemies=None, module_pool=None) -> World:
    ...
    if os.path.exists(json_path):
        world.grid, world.interactables, world.warp_tiles, world.player_start, world.enemies = \
            LevelLoader.load_json_map(json_path, saved_enemies=saved_enemies, module_pool=module_pool)
        return world
